...
> 🎨 커뮤니티 기반 시간 교환 플랫폼의 UI·UX를 중심으로 개선 
...
### ⏰ 시간은행이란?
고령화, 1인 가구 증가 등으로 인한 사회적 고립을 해결하기 위해,  
사람들 간에 서로의 ‘**시간**’을 나누고 기록하여 공동체를 회복하는 서비스입니다.

**💡 예시:**  
🧰 A가 B의 창고를 정리해주면 A는 1시간을 적립  
💬 이후 A는 자신이 필요할 때 C에게 1시간의 도움 요청 가능  
...
- 📊 **기타 문제 수정** -> 키보드 활성화 시 화면 가림 문제 해결, 회원가입 시 생년월일 입력 오류 해결
